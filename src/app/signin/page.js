    ...
    <main style={{
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '10px', justifyContent: 'center', marginBottom: '2rem' }}>
          <div style={{
            width: '36px', height: '36px', background: '#111',
          ...
          <span style={{ fontSize: '18px', fontWeight: '600', color: '#111' }}>Tutorverse</span>
        </div>
        ...
        <p style={{ fontSize: '14px', color: '#888', textAlign: 'center', marginBottom: '2rem' }}>
          Sign in to continue to Tutorverse
        </p>
        ...
        <form onSubmit={handleLogin}>
          ...
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '1.5rem' }}>
            ...
            <Link href="/forgot-password" style={{ fontSize: '13px', color: '#111', fontWeight: '500', textDecoration: 'none', borderBottom: '1px solid #ddd' }}>
              Forgot password?
            </Link>
          </div>
        ...
        {message && (
          <p style={{ textAlign: 'center', marginTop: '1rem', fontSize: '13px', color: '#ef4444', background: '#fef2f2', padding: '10px', borderRadius: '10px' }}>
            {message}
          </p>
        )}
        ...
        <div style={{ textAlign: 'center', marginTop: '1.5rem', fontSize: '13px', color: '#888' }}>
          ...
          <Link href="/signup" style={{ color: '#111', fontWeight: '600', textDecoration: 'none', borderBottom: '1px solid #ddd' }}>
            Sign up
          </Link>
        </div>
      </div>
